// src/components/metadata-images/MetadataImage.tsx
...
export function MetadataImage({
  ...
  const siteLogoImageSrc = 'https://slyro.vercel.app/images/site-logo.png'
...
function MetadataLogoImage({ image }: { image: Image }) {
  const imageSrc = `https://slyro.vercel.app${image.src}`
